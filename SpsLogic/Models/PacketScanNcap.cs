...
namespace SpsLogic
{
    public class PacketScanNpcap : IPacketScan
    {
        /// <summary>
        /// Stocks captures and write to pcap 
        /// you can execute save task only once
        /// </summary>
        public class PacketArchiveNpcap : BasePacketArchive
        {
            public override void AddCapture(object capture)
            {
                // Npcap archive output is intentionally not implemented yet.
            }
        ...
        public class PlayerPingHistoryNpcap : BasePlayerPingHistory
        {
            /// <summary>
            ...
            private readonly PacketArchiveNpcap archive;
            ...
            public PlayerPingHistoryNpcap(double patienceLimitMs, string name, ulong id)
            {
                archive = new PacketArchiveNpcap();
        ...
        /// </summary>
        private readonly Dictionary<ulong, PlayerPingHistoryNpcap> Registries;
        private readonly List<PlayerPingHistoryNpcap> OldHistories;
        private readonly List<PlayerPingHistoryNpcap> UnseenOldHistories;
        ...
        public PacketScanNpcap(double patienceLimitMs)
        {
            this.PatienceLimitMs = patienceLimitMs;
            Registries = new Dictionary<ulong, PlayerPingHistoryNpcap>();
            OldHistories = new List<PlayerPingHistoryNpcap>();
            UnseenOldHistories = new List<PlayerPingHistoryNpcap>();
            Stopwatch = new Stopwatch();
            Stopwatch.Start();
            Logger.Log("Setting up npcap network device listener", true);
        ...
        private void OnPacketArrival(object sender, PacketCapture e)
        {
            ...
            PlayerPingHistoryNpcap history = null;
